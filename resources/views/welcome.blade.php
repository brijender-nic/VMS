...
<body>
  ...
  <div class="container clearfix" id="b-header">
    ...
    <div class="float-left d-flex h-100">
      <b class="align-self-center pl-3"><span style="font-size: 24px;">VMS-NIC</span> <br><span
          style="font-size: 16px;"> Video Conference Participants Attendance Monitoring System</span> </b>
    </div>

    <div class="float-right d-flex h-100">
      <span class="align-self-center font-weight-bold" style="font-size:15px; text-align:right;">NATIONAL INFORMATICS
        CENTRE <br>
        <span>Ministry of Electronics & IT</span> <br>
        <span>Government of India</span>

      </span>
      <b class="align-self-center pl-3"><span><img src="images/NIC.png" alt="NIC logo"
            style="width: 120px; height: 50px;"></span></b>
    </div>
  </div>
  ...
  <!----------- Footer ------------>
  <div class="footer-bs fixed-bottom">
